...
router.get("/", async function(req, res) {
    ...
    try {
        ...
        //list of users and articles to template to display
        req.TPL.allUsers = allUsers;
        req.TPL.allArticles = allArticles;
        req.TPL.username = req.session.username;

        // rendering the page and return
        return res.render("editors", req.TPL);
    } catch (err) {
